...
delimiter &&
create procedure avg_bal_jobrole1(in give_input varchar(30))
begin 
select avg(balance) from bank_details where job=give_input;
end &&

call avg_bal_jobrole1('retired');
 
create view bank_view as select age,job,balance,education,marital from bank_details;
